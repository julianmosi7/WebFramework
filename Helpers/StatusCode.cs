namespace WebFramework.Helpers
{
  class StatusCode
  {
    ...
    public static string StatusDescription(int code)
    {
      switch (code)
      {
        ...
        case 449: return "The request should be retried after doing the appropriate action";
